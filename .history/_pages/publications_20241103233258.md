...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  ...
  <div>
    ...
    <p><em><a href="https://www.cs.cit.tum.de/cg/teaching/winter-term-22-23/machine-learning-for-3d-geometry/">Machine Learning for 3D Geometry</a></em></p>
    <p><a href="_publications/pdfs/Pixel2Mesh_for_3D_Human_Face_Reconstruction.pdf">Report</a></p>
    
    <p>This project utilizes Pixel2Mesh for reconstructing 3D human faces, exploring mesh-based approaches in the context of 3D geometry and machine learning.</p>
  </div>
</div>
